...
function create_xapi_sent_log_table($dbman, $tablename) {
    ...
    $table->add_field('timecreated', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
    $table->add_field('logstorestandardlogtime', XMLDB_TYPE_INTEGER, '10', null, XMLDB_NOTNULL, null, null);
    ...
    $table->add_index('timecreated', XMLDB_INDEX_NOTUNIQUE, array('timecreated'));
    $table->add_index('logstorestandardlogtime', XMLDB_INDEX_NOTUNIQUE, array('logstorestandardlogtime'));
